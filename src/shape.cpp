...
//         is_default_input ? CGAL::data_file_path("meshes/building.off")
//                          : argv[1];
...
//     std::endl; assert(!is_default_input || face_range.size() == 32245);
...
//     Region_growing region_growing(face_range, sorting.ordered(),
//     neighbor_query,
//                                   region_type);
//     // Run the algorithm.
...
//     region_growing.unassigned_items(face_range,
//     std::back_inserter(unassigned)); for (auto &item : unassigned) {
...
//         (argc > 2 ? argv[2] : "planes_polygon_mesh.ply");
